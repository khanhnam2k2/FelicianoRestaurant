        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <a href="{{route('admin.posts.index')}}" class="btn btn-primary mb-4">Posts Index</a>
                    ...
                    <div class="form-group">
                        <label for="body">Description (Maximum image width 700px)</label>
                        <textarea class="ckeditor form-control @error('description') is-invalid @enderror" name="body" placeholder="Description for category"
                            id="body" style="height: 150px;"></textarea>
                            @error('body')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
